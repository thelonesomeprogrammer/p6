...
function RobotMonitor() {
	...
	return (
		<div className="RobotMonitor">
			<Card className="">
				<h2 className="text-lg font-semibold text-gray-700 mb-2">Robot Monitor</h2>
				...
				{modbusData ? (
					...
					<div className="py-10 text-center text-gray-300 animate-pulse text-sm">Awaiting connection...</div>
				)}
			</Card>
		</div>
	);
