use crate::common::{ColumnState, map_features_to_indices, LANES};
...
impl ExpandingExtractor {
    ...
    pub fn update(
        ...
        for col_idx in 0..n_cols {
            ...
            let state = &mut self.states[col_idx];
            let history = &mut self.histories[col_idx];
            let sorted_history = &mut self.sorted_histories[col_idx];
